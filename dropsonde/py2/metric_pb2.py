...
# source: dropsonde/py2/metric.proto
...
ValueMetric = _reflection.GeneratedProtocolMessageType('ValueMetric', (_message.Message,), dict(
  ...
  __module__ = 'dropsonde.py2.metric_pb2'
